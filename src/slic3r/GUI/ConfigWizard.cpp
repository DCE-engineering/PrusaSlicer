...
void PageMaterials::update_lists(int sel_type, int sel_vendor, int last_selected_printer/* = -1*/)
{
    ...
    if (!are_equal(sel_printers, sel_printers_prev)) {
		...
		if (sel_printers_count > 1) {
            ...
            if (materials->technology == T_FFF && (sel_printers[0] == 1 || sel_printers[1] == 1) && sel_printers_count > 1) {
        ...
        if (sel_printers_count > 0 && sel_printers[0] != 0 && ((materials->technology == T_FFF && sel_printers[0] != 1) || materials->technology != T_FFF)) {
        ...
        else if (materials->technology == T_FFF && sel_printers_count > 0 && last_selected_printer == 1) {
